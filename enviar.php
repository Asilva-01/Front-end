...
// Mudar Aqui o e-mail
$email_envio = "andre81luiz@terra.com.br"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "82395014"; // Senha do e-mail

$site_name = "Bikcraft"; // Nome do Site
$site_url = "www.bikcraft.com"; // URL do Site

$host_smtp = "smtp.terra.com.br"; // HOST SMTP Ex: smtp.domain.com.br
